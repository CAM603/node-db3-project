...
SELECT DISTINCT OrderDetail.OrderId, Shipper.CompanyName, [Order].OrderDate FROM [OrderDetail]
...
SELECT [Order].Id AS 'Order Number', Customer.CompanyName AS 'Company Name', Employee.LastName AS 'Employee Last Name' FROM [Order]
